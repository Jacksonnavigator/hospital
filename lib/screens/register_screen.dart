...
// ═══════════════════════════════════════════════════════════════════
//  ClinicBook — Register Screen  (dark theme, matches welcome screen)
...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  Future<void> _register() async {
    ...
    try {
      final user = await SessionService.instance.register(
        _nameCtrl.text.trim(),
  ...
  void _goLogin() => Navigator.of(context).pushReplacement(PageRouteBuilder(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Join ClinicBook for easy appointments',
                            style: TextStyle(
